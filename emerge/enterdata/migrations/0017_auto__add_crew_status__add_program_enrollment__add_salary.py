...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Crew_status'
        db.create_table(u'enterdata_crew_status', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enterdata.Participant'])),
            ('crewstat_emply_type', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('crewstat_employer', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('crewstat_startdt', self.gf('django.db.models.fields.DateField')()),
            ('crewstat_status', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'enterdata', ['Crew_status'])

        # Adding model 'Program_enrollment'
        db.create_table(u'enterdata_program_enrollment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enterdata.Participant'])),
            ('penroll_ssn', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('penroll_complete', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('penroll_exit_dt', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('penroll_exit_status', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'enterdata', ['Program_enrollment'])

        # Adding model 'Salary'
        db.create_table(u'enterdata_salary', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enterdata.Participant'])),
            ('salary_date', self.gf('django.db.models.fields.DateField')()),
            ('salary_amt', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('salary_scale', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'enterdata', ['Salary'])


    def backwards(self, orm):
        # Deleting model 'Crew_status'
        db.delete_table(u'enterdata_crew_status')

        # Deleting model 'Program_enrollment'
        db.delete_table(u'enterdata_program_enrollment')

        # Deleting model 'Salary'
        db.delete_table(u'enterdata_salary')
    ...
    models = {
        ...
        u'enterdata.crew_status': {
            'Meta': {'object_name': 'Crew_status'},
            'crewstat_employer': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'crewstat_emply_type': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'crewstat_startdt': ('django.db.models.fields.DateField', [], {}),
            'crewstat_status': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'participant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['enterdata.Participant']"})
        },
        ...
        u'enterdata.program_enrollment': {
            'Meta': {'object_name': 'Program_enrollment'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'participant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['enterdata.Participant']"}),
            'penroll_complete': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'penroll_exit_dt': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'penroll_exit_status': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'penroll_ssn': ('django.db.models.fields.CharField', [], {'max_length': '4'})
        },
        u'enterdata.salary': {
            'Meta': {'object_name': 'Salary'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'participant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['enterdata.Participant']"}),
            'salary_amt': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'salary_date': ('django.db.models.fields.DateField', [], {}),
            'salary_scale': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
