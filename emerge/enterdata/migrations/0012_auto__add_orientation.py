...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Orientation'
        db.create_table(u'enterdata_orientation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enterdata.Participant'])),
            ('orientation_group', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('orientation_referral', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('orientation_supervision', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('orientation_startdt', self.gf('django.db.models.fields.DateField')()),
            ('orientation_compdt', self.gf('django.db.models.fields.DateField')()),
            ('orientation_education_level', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('orientation_medical_insurance', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('orientation_assessdt', self.gf('django.db.models.fields.DateField')()),
            ('orientation_wksp_startdt', self.gf('django.db.models.fields.DateField')()),
            ('orientation_wksp_enddt', self.gf('django.db.models.fields.DateField')()),
            ('orientation_wksp_complete', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('orientation_enrolleddt', self.gf('django.db.models.fields.DateField')()),
            ('orientation_firstpayrolldt', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'enterdata', ['Orientation'])


    def backwards(self, orm):
        # Deleting model 'Orientation'
        db.delete_table(u'enterdata_orientation')
