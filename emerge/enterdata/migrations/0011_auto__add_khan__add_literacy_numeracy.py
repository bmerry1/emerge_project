...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Khan'
        db.create_table(u'enterdata_khan', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enterdata.Participant'])),
            ('khan_dt', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'enterdata', ['Khan'])

        # Adding model 'Literacy_numeracy'
        db.create_table(u'enterdata_literacy_numeracy', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enterdata.Participant'])),
            ('litnum_timepoint', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('litnum_type', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('litnum_dt', self.gf('django.db.models.fields.DateField')()),
            ('litnum_raw', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('litnum_casas', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
        db.send_create_signal(u'enterdata', ['Literacy_numeracy'])


    def backwards(self, orm):
        # Deleting model 'Khan'
        db.delete_table(u'enterdata_khan')

        # Deleting model 'Literacy_numeracy'
        db.delete_table(u'enterdata_literacy_numeracy')
