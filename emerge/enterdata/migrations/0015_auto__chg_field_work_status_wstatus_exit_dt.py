...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Work_status.wstatus_exit_dt'
        db.alter_column(u'enterdata_work_status', 'wstatus_exit_dt', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Work_status.wstatus_exit_dt'
        db.alter_column(u'enterdata_work_status', 'wstatus_exit_dt', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 7, 24, 0, 0)))
