...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Probation'
        db.create_table(u'enterdata_probation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enterdata.Participant'])),
            ('probation_name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('probation_phone', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('probation_end_dt', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'enterdata', ['Probation'])

        # Adding model 'Legal'
        db.create_table(u'enterdata_legal', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enterdata.Participant'])),
            ('legal_charges', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('legal_convict_dt', self.gf('django.db.models.fields.DateField')()),
            ('legal_time_incar', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('legal_supervisor', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'enterdata', ['Legal'])


    def backwards(self, orm):
        # Deleting model 'Probation'
        db.delete_table(u'enterdata_probation')

        # Deleting model 'Legal'
        db.delete_table(u'enterdata_legal')
    ...
    models = {
        ...
        u'enterdata.legal': {
            ...
            'legal_supervisor': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
