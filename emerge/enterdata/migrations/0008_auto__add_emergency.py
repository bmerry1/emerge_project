...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Emergency'
        db.create_table(u'enterdata_emergency', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enterdata.Participant'])),
            ('emergency_fname', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('emergency_lname', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('emergency_phone', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal(u'enterdata', ['Emergency'])


    def backwards(self, orm):
        # Deleting model 'Emergency'
        db.delete_table(u'enterdata_emergency')
