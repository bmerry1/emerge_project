...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Prefix'
        db.create_table(u'enterdata_prefix', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'enterdata', ['Prefix'])


    def backwards(self, orm):
        # Deleting model 'Prefix'
        db.delete_table(u'enterdata_prefix')
    ...
    models = {
        ...
        u'enterdata.participants': {
            ...
            'participants_prefix': ('django.db.models.fields.CharField', [], {'default': "'Mr.'", 'max_length': '200'}),
