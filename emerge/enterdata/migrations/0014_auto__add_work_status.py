...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Work_status'
        db.create_table(u'enterdata_work_status', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enterdata.Participant'])),
            ('wstatus_start_dt', self.gf('django.db.models.fields.DateField')()),
            ('wstatus_exit_dt', self.gf('django.db.models.fields.DateField')()),
            ('wstatus_exit_status', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('wstatus_core_part', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('wstatus_success', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('wstatus_notes', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'enterdata', ['Work_status'])


    def backwards(self, orm):
        # Deleting model 'Work_status'
        db.delete_table(u'enterdata_work_status')
    ...
    models = {
        ...
        u'enterdata.work_status': {
            ...
            'wstatus_exit_dt': ('django.db.models.fields.DateField', [], {}),
