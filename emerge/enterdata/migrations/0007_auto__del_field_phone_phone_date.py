...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Phone.phone_date'
        db.delete_column(u'enterdata_phone', 'phone_date')


    def backwards(self, orm):
        # Adding field 'Phone.phone_date'
        db.add_column(u'enterdata_phone', 'phone_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 7, 23, 0, 0)),
                      keep_default=False)
