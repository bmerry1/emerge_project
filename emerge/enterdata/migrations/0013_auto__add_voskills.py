...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Voskills'
        db.create_table(u'enterdata_voskills', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enterdata.Participant'])),
            ('voskills_osha', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('voskills_osha_card', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('voskills_ct_driver', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('voskills_primary', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('voskills_service', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'enterdata', ['Voskills'])


    def backwards(self, orm):
        # Deleting model 'Voskills'
        db.delete_table(u'enterdata_voskills')
