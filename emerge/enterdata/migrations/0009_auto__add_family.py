...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Family'
        db.create_table(u'enterdata_family', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enterdata.Participant'])),
            ('family_residence', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('family_children', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal(u'enterdata', ['Family'])


    def backwards(self, orm):
        # Deleting model 'Family'
        db.delete_table(u'enterdata_family')
